...
# Create the JSON structure for Tirmidhi hadiths
tirmidhi_data = []
...
with open('/Users/mansoor/Desktop/Asyic/url/assets/data/hadiths/tirmidhi_data.json', 'w', encoding='utf-8') as f:
    json.dump(tirmidhi_data, f, ensure_ascii=False, indent=2)

print(f"\nGenerated JSON file with {hadith_counter - 1} hadiths")
print("Saved to: /Users/mansoor/Desktop/Asyic/url/assets/data/hadiths/tirmidhi_data.json")