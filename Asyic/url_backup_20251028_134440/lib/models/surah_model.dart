...
final List<Map<String, dynamic>> surahsData = [
  ...
  {'number': 37, 'name': 'الصافات', 'englishName': 'As-Saffat', 'englishNameTranslation': 'Those drawn up in Ranks', 'numberOfAyahs': 182, 'revelationType': 'Meccan'},
  ...
  {'number': 45, 'name': 'الجاثية', 'englishName': 'Al-Jathiya', 'englishNameTranslation': 'Crouching', 'numberOfAyahs': 37, 'revelationType': 'Meccan'},
  ...
  {'number': 49, 'name': 'الحجرات', 'englishName': 'Al-Hujurat', 'englishNameTranslation': 'The Inner Apartments', 'numberOfAyahs': 18, 'revelationType': 'Medinan'},
  {'number': 50, 'name': 'ق', 'englishName': 'Qaf', 'englishNameTranslation': 'The letter Qaaf', 'numberOfAyahs': 45, 'revelationType': 'Meccan'},
...
// Convert the list of maps to a list of Surah objects
final List<Surah> surahs = surahsData.map((surah) => Surah.fromJson(surah)).toList();
