...
import '../data/surah_al_anam_verses.dart';
import '../widgets/surah_app_bar.dart';

class SurahAlAnaamScreen extends StatefulWidget {
  const SurahAlAnaamScreen({super.key});

  @override
  State<SurahAlAnaamScreen> createState() => _SurahAlAnaamScreenState();
}

class _SurahAlAnaamScreenState extends State<SurahAlAnaamScreen> {
