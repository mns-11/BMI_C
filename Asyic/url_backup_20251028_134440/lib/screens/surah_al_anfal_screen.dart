...
import '../data/surah_al_anfal_verses.dart' show surahAlAnfalVerses;
import '../widgets/surah_app_bar.dart';

class SurahAlAnfalScreen extends StatefulWidget {
  const SurahAlAnfalScreen({super.key});

  @override
  State<SurahAlAnfalScreen> createState() => _SurahAlAnfalScreenState();
}

class _SurahAlAnfalScreenState extends State<SurahAlAnfalScreen> {
