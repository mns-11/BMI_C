...
import '../data/surah_al_araf_verses.dart' show surahAlArafVerses;
import '../widgets/surah_app_bar.dart';

class SurahAlArafScreen extends StatefulWidget {
  const SurahAlArafScreen({super.key});

  @override
  State<SurahAlArafScreen> createState() => _SurahAlArafScreenState();
}

class _SurahAlArafScreenState extends State<SurahAlArafScreen> {
