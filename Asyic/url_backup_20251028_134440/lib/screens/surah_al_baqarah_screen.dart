...
import '../data/surah_al_baqarah_verses.dart';
import '../widgets/surah_app_bar.dart';

class SurahAlBaqarahScreen extends StatefulWidget {
  const SurahAlBaqarahScreen({super.key});

  @override
  State<SurahAlBaqarahScreen> createState() => _SurahAlBaqarahScreenState();
}

class _SurahAlBaqarahScreenState extends State<SurahAlBaqarahScreen> {
        ...
        child: isLoading
            ? const Center(
                child: CircularProgressIndicator(
                  color: Color(0xFFB8860B), // Golden color
                ),
              )
            : ListView.builder(
                  ...
                  return Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          // Enhanced verse number with golden styling
                          Row(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  gradient: const LinearGradient(
                                    ...
                                    colors: [
                                      Color(0xFFD5580F), // App theme color
                                      Color(0xFFB8860B), // Golden accent
                                    ],
                                  ),
                                  boxShadow: [
                                    BoxShadow(
