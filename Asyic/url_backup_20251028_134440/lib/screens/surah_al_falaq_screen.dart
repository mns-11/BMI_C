...
import '../data/surah_al_falaq_verses.dart' show surahAlFalaqVerses;
import '../widgets/surah_app_bar.dart';

class SurahAlFalaqScreen extends StatefulWidget {
  const SurahAlFalaqScreen({super.key});

  @override
  State<SurahAlFalaqScreen> createState() => _SurahAlFalaqScreenState();
}

class _SurahAlFalaqScreenState extends State<SurahAlFalaqScreen> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Enhanced Arabic text with app theme styling
                          Container(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          if (verses.isNotEmpty) {
            final versesText = verses.map((v) => v['arabicText']).join('\n');
            Clipboard.setData(ClipboardData(text: versesText));
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('تم نسخ السورة'),
