...
import '../data/surah_al_fatihah_verses.dart';
import '../widgets/surah_app_bar.dart';

class SurahAlFatihaScreen extends StatefulWidget {
  const SurahAlFatihaScreen({super.key});

  @override
  State<SurahAlFatihaScreen> createState() => _SurahAlFatihaScreenState();
}

class _SurahAlFatihaScreenState extends State<SurahAlFatihaScreen> {
