...
import '../data/surah_al_hijr_verses.dart' show surahAlHijrVerses;
import '../widgets/surah_app_bar.dart';

class SurahAlHijrScreen extends StatefulWidget {
  const SurahAlHijrScreen({super.key});

  @override
  State<SurahAlHijrScreen> createState() => _SurahAlHijrScreenState();
}

class _SurahAlHijrScreenState extends State<SurahAlHijrScreen> {
