...
import '../data/surah_al_ikhlas_verses.dart' show surahAlIkhlasVerses;
import '../widgets/surah_app_bar.dart';

class SurahAlIkhlasScreen extends StatefulWidget {
  const SurahAlIkhlasScreen({super.key});

  @override
  State<SurahAlIkhlasScreen> createState() => _SurahAlIkhlasScreenState();
}

class _SurahAlIkhlasScreenState extends State<SurahAlIkhlasScreen> {
