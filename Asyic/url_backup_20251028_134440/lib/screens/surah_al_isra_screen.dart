...
import '../data/surah_al_isra_verses.dart' show surahAlIsraVerses;
import '../widgets/surah_app_bar.dart';

class SurahAlIsraScreen extends StatefulWidget {
  const SurahAlIsraScreen({super.key});

  @override
  State<SurahAlIsraScreen> createState() => _SurahAlIsraScreenState();
}

class _SurahAlIsraScreenState extends State<SurahAlIsraScreen> {
