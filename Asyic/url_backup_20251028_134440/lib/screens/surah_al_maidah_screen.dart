...
import '../data/surah_al_maidah_verses.dart' show surahAlMaidahVerses;
import '../widgets/surah_app_bar.dart';

class SurahAlMaidahScreen extends StatefulWidget {
  const SurahAlMaidahScreen({super.key});

  @override
  State<SurahAlMaidahScreen> createState() => _SurahAlMaidahScreenState();
}

class _SurahAlMaidahScreenState extends State<SurahAlMaidahScreen> {
