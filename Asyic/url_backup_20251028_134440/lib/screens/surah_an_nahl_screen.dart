...
import '../data/surah_an_nahl_verses.dart' show surahAnNahlVerses;
import '../widgets/surah_app_bar.dart';

class SurahAnNahlScreen extends StatefulWidget {
  const SurahAnNahlScreen({super.key});

  @override
  State<SurahAnNahlScreen> createState() => _SurahAnNahlScreenState();
}

class _SurahAnNahlScreenState extends State<SurahAnNahlScreen> {
