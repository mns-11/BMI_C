...
import '../data/surah_an_nas_verses.dart' show surahAnNasVerses;
import '../widgets/surah_app_bar.dart';

class SurahAnNasScreen extends StatefulWidget {
  const SurahAnNasScreen({super.key});

  @override
  State<SurahAnNasScreen> createState() => _SurahAnNasScreenState();
}

class _SurahAnNasScreenState extends State<SurahAnNasScreen> {
