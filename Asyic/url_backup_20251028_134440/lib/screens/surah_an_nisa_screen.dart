...
import '../data/surah_an_nisa_verses.dart' show surahAnNisaVerses;
import '../widgets/surah_app_bar.dart';

class SurahAnNisaScreen extends StatefulWidget {
  const SurahAnNisaScreen({super.key});

  @override
  State<SurahAnNisaScreen> createState() => _SurahAnNisaScreenState();
}

class _SurahAnNisaScreenState extends State<SurahAnNisaScreen> {
