...
import '../data/surah_ar_rad_verses.dart' show surahArRadVerses;
import '../widgets/surah_app_bar.dart';

class SurahArRadScreen extends StatefulWidget {
  const SurahArRadScreen({super.key});

  @override
  State<SurahArRadScreen> createState() => _SurahArRadScreenState();
}

class _SurahArRadScreenState extends State<SurahArRadScreen> {
