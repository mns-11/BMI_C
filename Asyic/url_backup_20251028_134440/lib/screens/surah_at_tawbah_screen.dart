...
import '../data/surah_at_tawbah_verses.dart' show surahAtTawbahVerses;
import '../widgets/surah_app_bar.dart';

class SurahAtTawbahScreen extends StatefulWidget {
  const SurahAtTawbahScreen({super.key});

  @override
  State<SurahAtTawbahScreen> createState() => _SurahAtTawbahScreenState();
}

class _SurahAtTawbahScreenState extends State<SurahAtTawbahScreen> {
