...
import '../data/surah_hud_verses.dart' show surahHudVerses;
import '../widgets/surah_app_bar.dart';

class SurahHudScreen extends StatefulWidget {
  const SurahHudScreen({super.key});

  @override
  State<SurahHudScreen> createState() => _SurahHudScreenState();
}

class _SurahHudScreenState extends State<SurahHudScreen> {
