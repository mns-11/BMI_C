...
import '../data/surah_ibrahim_verses.dart' show surahIbrahimVerses;
import '../widgets/surah_app_bar.dart';

class SurahIbrahimScreen extends StatefulWidget {
  const SurahIbrahimScreen({super.key});

  @override
  State<SurahIbrahimScreen> createState() => _SurahIbrahimScreenState();
}

class _SurahIbrahimScreenState extends State<SurahIbrahimScreen> {
