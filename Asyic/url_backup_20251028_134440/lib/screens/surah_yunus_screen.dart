...
import '../data/surah_yunus_verses.dart' show surahYunusVerses;
import '../widgets/surah_app_bar.dart';

class SurahYunusScreen extends StatefulWidget {
  const SurahYunusScreen({super.key});

  @override
  State<SurahYunusScreen> createState() => _SurahYunusScreenState();
}

class _SurahYunusScreenState extends State<SurahYunusScreen> {
