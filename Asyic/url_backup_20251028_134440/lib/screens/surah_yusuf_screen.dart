...
import '../data/surah_yusuf_verses.dart' show surahYusufVerses;
import '../widgets/surah_app_bar.dart';

class SurahYusufScreen extends StatefulWidget {
  const SurahYusufScreen({super.key});

  @override
  State<SurahYusufScreen> createState() => _SurahYusufScreenState();
}

class _SurahYusufScreenState extends State<SurahYusufScreen> {
